...
public abstract class RedisSentinel {
	...
	// 连接池的配置 (如果不设置，使用默认值)
	protected GenericObjectPoolConfig poolConfig = new GenericObjectPoolConfig();
	 ...
	 *            集群名
	 */
	protected void checkRedisSentinelServer(final RedisSentinel redisSentinel, final int againCheckTime,
